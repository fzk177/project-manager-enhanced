...
const insightsMemberDashboardPath = join(repositoryRoot, 'custom', 'insights-member-dashboard.css')
...
const insightsMemberDashboard = readFileSync(insightsMemberDashboardPath, 'utf8').trimEnd()
const iterationDetail = readFileSync(iterationDetailPath, 'utf8')
writeFileSync(
  outputPath,
  `${source}\n\n/* Project Manager Insights 0.2.4 · MIT */\n${insights}\n\n${dashboard}\n\n${insightsMemberDashboard}\n\n${iterationDetail}`,
  'utf8',
)
